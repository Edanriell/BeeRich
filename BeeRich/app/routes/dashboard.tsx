						...
						<ul className="mt-10 w-full flex flex-row gap-5">
							<li className="ml-auto">
								<NavLink
									to={
										firstInvoice
											? `/dashboard/income/${firstInvoice.id}`
											: "/dashboard/income"
									}
									styleAsActive={location.pathname.startsWith(
										"/dashboard/income"
									)}
									prefetch="intent"
								>
							...
							<li className="mr-auto">
								<NavLink
									to={
										firstExpense
											? `/dashboard/expenses/${firstExpense.id}`
											: "/dashboard/expenses"
									}
									styleAsActive={location.pathname.startsWith(
										"/dashboard/expenses"
	...
	return (
		<Layout firstExpense={null} firstInvoice={null}>
			<Container className="p-5 lg:p-20 flex flex-col gap-5">
				...
				<p>
					We are very sorry. An unexpected error occurred. Please try again or contact us
