			...
			<section className="w-full">
				<Form>
					...
					<Input
						...
						type="text"
						name="email"
						placeholder="bee.rich@email.com"
					/>
			...
			<section className="w-full">
				<Card>
					...
					<Paragraph>
						...
						nec consectetur tincidunt, nunc nisl aliquam nisl, eget aliquam nisl nunc
						vel nisl. Sed euismod, nisl nec consectetur tincidunt, nunc nisl aliquam
